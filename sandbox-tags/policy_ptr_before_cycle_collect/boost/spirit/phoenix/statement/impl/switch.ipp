...
==============================================================================*/
#ifndef PHOENIX_STATEMENT_IMPL_SWITCH_IPP
#define PHOENIX_STATEMENT_IMPL_SWITCH_IPP
...
namespace boost { namespace phoenix
{
    ...
    namespace impl
    {
        ...
        struct compose_case_b
        {
            ...
            {
                return fusion::push_back(seq, actor<Case>(case_));
            }

            static type
            apply(Seq const& seq, Case const& case_, mpl::true_)
            {
                return fusion::push_front(seq, actor<Case>(case_));
            }
        ...
        struct switch_composite
        {
            ...
            typedef
                composite<
                    impl::switch_eval<fusion::meta::size<tuple_type>::value-2>
                  , tuple_type>
            type;
