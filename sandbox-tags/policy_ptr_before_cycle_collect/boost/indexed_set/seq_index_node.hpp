...
#ifndef BOOST_INDEXED_SET_SEQ_INDEX_NODE_HPP
#define BOOST_INDEXED_SET_SEQ_INDEX_NODE_HPP
...
/* doubly-linked node for use by indexed_set::sequenced_index */
...
struct sequenced_index_node_impl
{
  ...
  static void link(sequenced_index_node_impl* x,sequenced_index_node_impl* header)
  {
  ...
  static void relink(sequenced_index_node_impl* position,sequenced_index_node_impl* x)
  {
    unlink(x);
  ...
  static void swap(sequenced_index_node_impl* x,sequenced_index_node_impl* y)
  {
     ...
     * but rather its pointers. This is *not* used for implementing
...
template<typename Super> struct sequenced_index_node_trampoline:sequenced_index_node_impl{};
...
struct sequenced_index_node:Super,sequenced_index_node_trampoline<Super>
{
  ...
  sequenced_index_node_impl*       impl(){return static_cast<impl_type*>(this);}
  const sequenced_index_node_impl* impl()const{return static_cast<const impl_type*>(this);}
  ...
  static const sequenced_index_node* from_impl(const sequenced_index_node_impl* x)
    {return static_cast<const sequenced_index_node*>(static_cast<const impl_type*>(x));}
