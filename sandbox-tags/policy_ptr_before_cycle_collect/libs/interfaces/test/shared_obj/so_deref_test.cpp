...
void deref_test()
{
    ...
    shared_obj<ifirst> first(new cfirst<1>);
    first.one(0, 0.0F);
    first.one("");
    first.two();
    ...
    shared_obj<iderived1> derived1(new cderived1<1>);
    derived1.one(0, 0.0F);
    derived1.one("");
    derived1.two();
    ...
    shared_obj<iderived4> derived4(new cderived4<1>);
    derived4.one(0, 0.0F);
    derived4.one("");
    derived4.two();
...
{
    test_suite* test = BOOST_TEST_SUITE("shared_obj deref test");
