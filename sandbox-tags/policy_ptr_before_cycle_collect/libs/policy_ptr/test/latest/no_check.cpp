...
//  pointer library.  This test should crash, which is why it is in its own
//  file.  See libs/policy_ptr/doc/index.html
//
//////////////////////////////////////////////////////////////////////////////
...
namespace boost
{
    ...
    void no_check_test(void)
    {
        smart_ptr<object, no_check<_> > p;
        p->x();
    }
}
...
{
    test::test_suite* test = BOOST_TEST_SUITE("smart_ptr no_check test");

    test->add(BOOST_TEST_CASE(&no_check_test));
