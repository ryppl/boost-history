...
namespace boost
{
  namespace tupple
  {
    template < class T > struct tuple0
    {
      ...
      template < class T0 > struct tuple1
    {
      typedef T0 type0;
      ...
      template < class S0 > tuple1( const tuple1 < S0 > &rhs ):m0( rhs.m0 )
      {
      }
      tuple1( arg_type0 theM0, const tail_type & tail ):m0( theM0 )
      {
      }
      template < class S0 > self_type & operator=( const tuple1 < S0 > &rhs )
      {
    ...
    template < class T0, class T1 > struct tuple2
    {
      typedef T0 type0;
      typedef T1 type1;
      typedef access_traits < T0 >::arg_type arg_type0;
      ...
      template < class S0, class S1 > tuple2( const tuple2 < S0,
                                              S1 > &rhs ):m0( rhs.m0 ),
        m1( rhs.m1 )
      {
      }
      ...
      template < class S0,
        class S1 > self_type & operator=( const tuple2 < S0, S1 > &rhs )
      {
        if( this != ( self_type * ) ( &rhs ) )
        {
          m0 = rhs.m0;
    ...
    template < class T0, class T1, class T2 > struct tuple3
    {
      typedef T0 type0;
      typedef T1 type1;
      typedef T2 type2;
      ...
      tuple3( arg_type0 theM0, arg_type1 theM1, arg_type2 theM2 ):m0( theM0 ),
        m1( theM1 ), m2( theM2 )
      {
      }
      template < class S0, class S1, class S2 > tuple3( const tuple3 < S0, S1,
                                                        S2 >
                                                        &rhs ):m0( rhs.m0 ),
        m1( rhs.m1 ), m2( rhs.m2 )
      {
      ...
      template < class S0, class S1,
        class S2 > self_type & operator=( const tuple3 < S0, S1, S2 > &rhs )
      {
        if( this != ( self_type * ) ( &rhs ) )
        {
          m0 = rhs.m0;
    ...
    template < class T0, class T1, class T2, class T3 > struct tuple4
    {
      typedef T0 type0;
      typedef T1 type1;
      typedef T2 type2;
      ...
      template < class S0, class S1, class S2,
        class S3 > tuple4( const tuple4 < S0, S1, S2,
      ...
      template < class S0, class S1, class S2,
        class S3 > self_type & operator=( const tuple4 < S0, S1, S2,
                                          S3 > &rhs )
      {
        if( this != ( self_type * ) ( &rhs ) )
        {
    ...
    template < class T0, class T1, class T2, class T3, class T4 > struct tuple5
    {
      typedef T0 type0;
      typedef T1 type1;
      typedef T2 type2;
      ...
      template < class S0, class S1, class S2, class S3,
        class S4 > tuple5( const tuple5 < S0, S1, S2, S3,
      ...
      template < class S0, class S1, class S2, class S3,
        class S4 > self_type & operator=( const tuple5 < S0, S1, S2, S3,
                                          S4 > &rhs )
      {
        if( this != ( self_type * ) ( &rhs ) )
        {
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5 > struct tuple6
    {
      typedef T0 type0;
      typedef T1 type1;
      typedef T2 type2;
      ...
      template < class S0, class S1, class S2, class S3, class S4,
        class S5 > tuple6( const tuple6 < S0, S1, S2, S3, S4,
      ...
      template < class S0, class S1, class S2, class S3, class S4,
        class S5 > self_type & operator=( const tuple6 < S0, S1, S2, S3, S4,
                                          S5 > &rhs )
      {
        if( this != ( self_type * ) ( &rhs ) )
        {
      ...
      class T6 > struct tuple7
    {
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6 > tuple7( const tuple7 < S0, S1, S2, S3, S4, S5,
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6 > self_type & operator=( const tuple7 < S0, S1, S2, S3, S4,
                                          S5, S6 > &rhs )
      {
        if( this != ( self_type * ) ( &rhs ) )
        {
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7 > struct tuple8
    {
      typedef T0 type0;
      typedef T1 type1;
      typedef T2 type2;
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6, class S7 > tuple8( const tuple8 < S0, S1, S2, S3, S4, S5,
                                     S6, S7 > &rhs ):m0( rhs.m0 ),
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6, class S7 > self_type & operator=( const tuple8 < S0, S1, S2,
                                                    S3, S4, S5, S6,
                                                    S7 > &rhs )
      {
        if( this != ( self_type * ) ( &rhs ) )
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7, class T8 > struct tuple9
    {
      typedef T0 type0;
      typedef T1 type1;
      typedef T2 type2;
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6, class S7, class S8 > tuple9( const tuple9 < S0, S1, S2, S3,
                                               S4, S5, S6, S7,
                                               S8 > &rhs ):m0( rhs.m0 ),
        m1( rhs.m1 ), m2( rhs.m2 ), m3( rhs.m3 ), m4( rhs.m4 ), m5( rhs.m5 ),
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6, class S7,
        class S8 > self_type & operator=( const tuple9 < S0, S1, S2, S3, S4,
                                          S5, S6, S7, S8 > &rhs )
      {
        if( this != ( self_type * ) ( &rhs ) )
        {
    ...
    template < class T0 > tuple1 < make_tuple_traits < T0 >::type >
      make_tuple( const T0 & theM0 )
    {
      return tuple1 < make_tuple_traits < T0 >::type > ( theM0 );
    }
    template < class T0 > struct make_tuple_function1
    {
      typedef tuple1 < make_tuple_traits < T0 >::type > result_type;
      result_type operator(  ) ( const T0 & theM0 ) const
      {
        return result_type( theM0 );
      }
    };
    template < class T0 > tuple1 < detail::assign_to_pointee < T0 >
      >tie( T0 & theM0 )
    {
    ...
    template < class T0, class T1 > tuple2 < make_tuple_traits < T0 >::type,
      make_tuple_traits < T1 >::type > make_tuple( const T0 & theM0,
                                                   const T1 & theM1 )
    {
      return tuple2 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type > ( theM0, theM1 );
    }
    template < class T0, class T1 > struct make_tuple_function2
    {
      typedef tuple2 < make_tuple_traits < T0 >::type,
    ...
    template < class T0, class T1 > tuple2 < detail::assign_to_pointee < T0 >,
    ...
    template < class T0, class T1,
      class T2 > tuple3 < make_tuple_traits < T0 >::type,
      make_tuple_traits < T1 >::type,
      make_tuple_traits < T2 >::type > make_tuple( const T0 & theM0,
                                                   const T1 & theM1,
                                                   const T2 & theM2 )
    {
      return tuple3 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type,
        make_tuple_traits < T2 >::type > ( theM0, theM1, theM2 );
    }
    template < class T0, class T1, class T2 > struct make_tuple_function3
    {
      typedef tuple3 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type,
    ...
    template < class T0, class T1,
      class T2 > tuple3 < detail::assign_to_pointee < T0 >,
    ...
    template < class T0, class T1, class T2,
      class T3 > tuple4 < make_tuple_traits < T0 >::type,
      ...
      make_tuple_traits < T3 >::type > make_tuple( const T0 & theM0,
                                                   ...
                                                   const T3 & theM3 )
    {
      return tuple4 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type > ( theM0, theM1, theM2, theM3 );
    }
    template < class T0, class T1, class T2, class T3 > struct make_tuple_function4
    {
      typedef tuple4 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
    ...
    template < class T0, class T1, class T2,
      class T3 > tuple4 < detail::assign_to_pointee < T0 >,
    ...
    template < class T0, class T1, class T2, class T3,
      class T4 > tuple5 < make_tuple_traits < T0 >::type,
      make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
      ...
      make_tuple_traits < T4 >::type > make_tuple( const T0 & theM0,
                                                   ...
                                                   const T4 & theM4 )
    {
      return tuple5 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type,
        make_tuple_traits < T4 >::type > ( theM0, theM1, theM2, theM3,
                                           theM4 );
    }
    template < class T0, class T1, class T2, class T3, class T4 > struct make_tuple_function5
    {
      typedef tuple5 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type,
    ...
    template < class T0, class T1, class T2, class T3,
      class T4 > tuple5 < detail::assign_to_pointee < T0 >,
      detail::assign_to_pointee < T1 >, detail::assign_to_pointee < T2 >,
    ...
    template < class T0, class T1, class T2, class T3, class T4,
      class T5 > tuple6 < make_tuple_traits < T0 >::type,
      make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
      ...
      make_tuple_traits < T5 >::type > make_tuple( const T0 & theM0,
                                                   ...
                                                   const T5 & theM5 )
    {
      return tuple6 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
        make_tuple_traits < T5 >::type > ( theM0, theM1, theM2, theM3, theM4,
                                           theM5 );
    }
    template < class T0, class T1, class T2, class T3, class T4, class T5 > struct make_tuple_function6
    {
      typedef tuple6 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
    ...
    template < class T0, class T1, class T2, class T3, class T4,
      class T5 > tuple6 < detail::assign_to_pointee < T0 >,
      detail::assign_to_pointee < T1 >, detail::assign_to_pointee < T2 >,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6 > tuple7 < make_tuple_traits < T0 >::type,
      make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
      make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
      ...
      make_tuple_traits < T6 >::type > make_tuple( const T0 & theM0,
                                                   ...
                                                   const T6 & theM6 )
    {
      return tuple7 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
        make_tuple_traits < T5 >::type,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6 > struct make_tuple_function7
    {
      typedef tuple7 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
        make_tuple_traits < T5 >::type,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6 > tuple7 < detail::assign_to_pointee < T0 >,
      detail::assign_to_pointee < T1 >, detail::assign_to_pointee < T2 >,
      detail::assign_to_pointee < T3 >, detail::assign_to_pointee < T4 >,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7 > tuple8 < make_tuple_traits < T0 >::type,
      make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
      make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
      ...
      make_tuple_traits < T7 >::type > make_tuple( const T0 & theM0,
                                                   ...
                                                   const T7 & theM7 )
    {
      return tuple8 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
        make_tuple_traits < T5 >::type, make_tuple_traits < T6 >::type,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7 > struct make_tuple_function8
    {
      typedef tuple8 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
        make_tuple_traits < T5 >::type, make_tuple_traits < T6 >::type,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7 > tuple8 < detail::assign_to_pointee < T0 >,
      detail::assign_to_pointee < T1 >, detail::assign_to_pointee < T2 >,
      detail::assign_to_pointee < T3 >, detail::assign_to_pointee < T4 >,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7, class T8 > tuple9 < make_tuple_traits < T0 >::type,
      make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
      make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
      make_tuple_traits < T5 >::type, make_tuple_traits < T6 >::type,
      ...
      make_tuple_traits < T8 >::type > make_tuple( const T0 & theM0,
                                                   ...
                                                   const T8 & theM8 )
    {
      return tuple9 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
        make_tuple_traits < T5 >::type, make_tuple_traits < T6 >::type,
        make_tuple_traits < T7 >::type,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7, class T8 > struct make_tuple_function9
    {
      typedef tuple9 < make_tuple_traits < T0 >::type,
        make_tuple_traits < T1 >::type, make_tuple_traits < T2 >::type,
        make_tuple_traits < T3 >::type, make_tuple_traits < T4 >::type,
        make_tuple_traits < T5 >::type, make_tuple_traits < T6 >::type,
        make_tuple_traits < T7 >::type,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7,
      class T8 > tuple9 < detail::assign_to_pointee < T0 >,
      detail::assign_to_pointee < T1 >, detail::assign_to_pointee < T2 >,
      detail::assign_to_pointee < T3 >, detail::assign_to_pointee < T4 >,
      detail::assign_to_pointee < T5 >, detail::assign_to_pointee < T6 >,
    ...
    template < class R, class T0 > struct pointer_to_function1
    {
      typedef tuple1 < T0 > argument_type;
      typedef R result_type;
    ...
    template < class R, class T0 > inline pointer_to_function1 < R,
      T0 > ptr_fct( R( *theF ) ( T0 ) )
    {
      return pointer_to_function1 < R, T0 > ( theF );
    }
    template < class F, class R, class T0, class T1 > struct function_object2
    {
    ...
    template < class R, class T0, class T1 > struct pointer_to_function2
    {
      typedef tuple2 < T0, T1 > argument_type;
      typedef R result_type;
    ...
    template < class R, class T0, class T1 > inline pointer_to_function2 < R,
      T0, T1 > ptr_fct( R( *theF ) ( T0, T1 ) )
    {
      return pointer_to_function2 < R, T0, T1 > ( theF );
    }
    template < class F, class R, class T0, class T1, class T2 > struct function_object3
    {
    ...
    template < class R, class T0, class T1, class T2 > struct pointer_to_function3
    {
      typedef tuple3 < T0, T1, T2 > argument_type;
      typedef R result_type;
    ...
    template < class R, class T0, class T1,
      class T2 > inline pointer_to_function3 < R, T0, T1,
      T2 > ptr_fct( R( *theF ) ( T0, T1, T2 ) )
    {
      return pointer_to_function3 < R, T0, T1, T2 > ( theF );
    }
    template < class F, class R, class T0, class T1, class T2, class T3 > struct function_object4
    {
    ...
    template < class R, class T0, class T1, class T2, class T3 > struct pointer_to_function4
    {
      typedef tuple4 < T0, T1, T2, T3 > argument_type;
      typedef R result_type;
    ...
    template < class R, class T0, class T1, class T2,
      class T3 > inline pointer_to_function4 < R, T0, T1, T2,
    ...
    template < class F, class R, class T0, class T1, class T2, class T3,
      class T4 > struct function_object5
    {
    ...
    template < class R, class T0, class T1, class T2, class T3, class T4 > struct pointer_to_function5
    {
      typedef tuple5 < T0, T1, T2, T3, T4 > argument_type;
      typedef R result_type;
    ...
    template < class R, class T0, class T1, class T2, class T3,
      class T4 > inline pointer_to_function5 < R, T0, T1, T2, T3,
      T4 > ptr_fct( R( *theF ) ( T0, T1, T2, T3, T4 ) )
    {
      return pointer_to_function5 < R, T0, T1, T2, T3, T4 > ( theF );
    }
    template < class F, class R, class T0, class T1, class T2, class T3,
      class T4, class T5 > struct function_object6
    {
    ...
    template < class R, class T0, class T1, class T2, class T3, class T4,
      class T5 > struct pointer_to_function6
    {
      typedef tuple6 < T0, T1, T2, T3, T4, T5 > argument_type;
      typedef R result_type;
      ...
      pointer_to_function6( R( *theF ) ( T0, T1, T2, T3, T4, T5 ) ):f( theF )
      {
      }
      R operator(  ) ( const tuple6 < T0, T1, T2, T3, T4, T5 > &arg )
      {
    ...
    template < class R, class T0, class T1, class T2, class T3, class T4,
      class T5 > inline pointer_to_function6 < R, T0, T1, T2, T3, T4,
      T5 > ptr_fct( R( *theF ) ( T0, T1, T2, T3, T4, T5 ) )
    {
      return pointer_to_function6 < R, T0, T1, T2, T3, T4, T5 > ( theF );
    }
    template < class F, class R, class T0, class T1, class T2, class T3,
      class T4, class T5, class T6 > struct function_object7
    {
    ...
    template < class R, class T0, class T1, class T2, class T3, class T4,
      class T5, class T6 > struct pointer_to_function7
    {
      typedef tuple7 < T0, T1, T2, T3, T4, T5, T6 > argument_type;
      typedef R result_type;
    ...
    template < class R, class T0, class T1, class T2, class T3, class T4,
      class T5, class T6 > inline pointer_to_function7 < R, T0, T1, T2, T3,
      T4, T5, T6 > ptr_fct( R( *theF ) ( T0, T1, T2, T3, T4, T5, T6 ) )
    {
      return pointer_to_function7 < R, T0, T1, T2, T3, T4, T5, T6 > ( theF );
    }
    template < class F, class R, class T0, class T1, class T2, class T3,
      class T4, class T5, class T6, class T7 > struct function_object8
    {
      ...
      R operator(  ) ( const tuple8 < T0, T1, T2, T3, T4, T5, T6, T7 > &arg )
      {
        return f( arg.m0, arg.m1, arg.m2, arg.m3, arg.m4, arg.m5, arg.m6,
                  arg.m7 );
      }
    ...
    template < class R, class T0, class T1, class T2, class T3, class T4,
      class T5, class T6, class T7 > struct pointer_to_function8
    {
      typedef tuple8 < T0, T1, T2, T3, T4, T5, T6, T7 > argument_type;
      typedef R result_type;
      ...
      pointer_to_function8( R( *theF ) ( T0, T1, T2, T3, T4, T5, T6, T7 ) ):f
        ( theF )
      {
      }
      R operator(  ) ( const tuple8 < T0, T1, T2, T3, T4, T5, T6, T7 > &arg )
    ...
    template < class R, class T0, class T1, class T2, class T3, class T4,
      class T5, class T6, class T7 > inline pointer_to_function8 < R, T0, T1,
      T2, T3, T4, T5, T6,
    ...
    template < class F, class R, class T0, class T1, class T2, class T3,
      ...
      class T8 > struct function_object9
    {
    ...
    template < class R, class T0, class T1, class T2, class T3, class T4,
      class T5, class T6, class T7, class T8 > struct pointer_to_function9
    {
      typedef tuple9 < T0, T1, T2, T3, T4, T5, T6, T7, T8 > argument_type;
      typedef R result_type;
    ...
    template < class T0, class T1, class S0,
      class S1 > bool operator==( const tuple2 < T0, T1 > &lhs,
    ...
    template < class T0, class T1, class T2, class S0, class S1,
      class S2 > bool operator==( const tuple3 < T0, T1, T2 > &lhs,
    ...
    template < class T0, class T1, class T2, class T3, class S0, class S1,
      class S2, class S3 > bool operator==( const tuple4 < T0, T1, T2,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class S0,
      ...
      class S4 > bool operator==( const tuple5 < T0, T1, T2, T3, T4 > &lhs,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      ...
      class S5 > bool operator==( const tuple6 < T0, T1, T2, T3, T4,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class S0, class S1, class S2, class S3, class S4,
      class S5 > bool operator<( const tuple6 < T0, T1, T2, T3, T4, T5 > &lhs,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      ...
      class S6 > bool operator==( const tuple7 < T0, T1, T2, T3, T4, T5,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      ...
      class S5, class S6, class S7 > bool operator==( const tuple8 < T0, T1,
                                                      T2, T3, T4, T5, T6,
                                                      T7 > &lhs,
                                                      const tuple8 < S0, S1,
                                                      S2, S3, S4, S5, S6,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      ...
      class S8 > bool operator==( const tuple9 < T0, T1, T2, T3, T4, T5, T6,
