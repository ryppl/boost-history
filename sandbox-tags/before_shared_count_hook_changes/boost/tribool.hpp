 ...
 *
 * \returns @p x.value == tribool::indeterminate_value
 * \throws nothrow
 */
inline bool
 ...
 * to \c indeterminate), all of which will be equivalent.
 */
#define BOOST_TRIBOOL_THIRD_STATE(Name)                         \
inline bool                                                     \
Name(boost::tribool x,                                          \
     boost::detail::indeterminate_t dummy =                     \
       boost::detail::indeterminate_t())                        \
