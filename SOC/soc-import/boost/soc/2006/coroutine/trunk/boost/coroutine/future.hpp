...
namespace boost { namespace coroutines {
  ...
  class future : public movable<future<BOOST_PP_ENUM_PARAMS(BOOST_COROUTINE_ARG_MAX, T)> > {
...
#elif defined(BOOST_COROUTINE_NONCOPYABLE_FUTURE)
