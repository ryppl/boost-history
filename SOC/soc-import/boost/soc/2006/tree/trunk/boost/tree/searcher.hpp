...
std::pair<nary_tree_cursor<Node>, std::pair<bool, bool> > //TODO: ugly return type. use tuple instead?
key_lower_bound(nary_tree_cursor<Node> c, typename Extract::result_type key, 
