...
/// \file tagged/support/apply_to_value_type.hpp
/// \brief Similar to mpl::apply but for tagged types.

#ifndef BOOST_BIMAP_TAGGED_SUPPORT_APPLY_TO_VALUE_TYPE_HPP
#define BOOST_BIMAP_TAGGED_SUPPORT_APPLY_TO_VALUE_TYPE_HPP

#include <boost/bimap/tagged/tagged.hpp>
#include <boost/mpl/apply.hpp>

/** \struct boost::bimap::tagged::support::apply_to_value_type
...
#endif // BOOST_BIMAP_TAGGED_SUPPORT_APPLY_TO_VALUE_TYPE_HPP
