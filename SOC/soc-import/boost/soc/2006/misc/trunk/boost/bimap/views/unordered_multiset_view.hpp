    ...
    public ::boost::bimap::detail::set_view_base< unordered_multiset_view< IndexType >, IndexType >
{
        ...
        typedef ::boost::bimap::detail::set_view_base< unordered_multiset_view< IndexType >, IndexType >
            friend_set_view_base;
        friend class friend_set_view_base;
    #else
        friend class ::boost::bimap::detail::set_view_base< unordered_multiset_view< IndexType >, IndexType >;
    #endif
