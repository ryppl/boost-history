...
#ifndef BOOST_ACT_INTERLOCKED_INCREMENT_INC_HPP
#define BOOST_ACT_INTERLOCKED_INCREMENT_INC_HPP
...
>
::type
increment( Type volatile& destination )
{
  return BOOST_INTERLOCKED_INCREMENT
