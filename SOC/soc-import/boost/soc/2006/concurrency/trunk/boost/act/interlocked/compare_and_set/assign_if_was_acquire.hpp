...
#ifndef BOOST_ACT_INTERLOCKED_COMPARE_AND_ASSIGN_CAS_ACQUIRE_HPP
#define BOOST_ACT_INTERLOCKED_COMPARE_AND_ASSIGN_CAS_ACQUIRE_HPP
...
>
::type
assign_if_was_acquire( TargetType volatile& destination
