...
#ifndef BOOST_ACT_INTERLOCKED_INCREMENT_INC_RELEASE_HPP
#define BOOST_ACT_INTERLOCKED_INCREMENT_INC_RELEASE_HPP
...
>
::type
increment_release( Type volatile& destination )
{
