...
void test_spots(T, const char* type_name)
{
    ...
    static const boost::array<boost::array<T, 2>, 10> data = {
        ...
        SC_(1e-05), SC_(-6.366197727536548515747484843924772510915e+04),
        SC_(1e-10), SC_(-6.366197723675813431507891842844626117091e+09),
        SC_(1e-20), SC_(-6.366197723675813779877633701282183024017e+19),
        SC_(1e+03), SC_(-0.02478433129235177891486235609714129093863),
        SC_(1e+05), SC_(0.001719210350088256300994945235398971029545),
    };
    #undef SC_
