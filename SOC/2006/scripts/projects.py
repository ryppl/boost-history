...
# tuples (project-name, student-id, mentor-id)
projects = [
    ...
    ('misc', 'matias.capeletto', 'joaquin.munoz'),
    ('fsm-viewer', 'tibuleac.ioana', 'andreas.donni'),
    ('modules', 'lally.singh', 'joel'),
    ('coroutine','giovanni.deretta', 'eric')]
