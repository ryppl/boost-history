...
==============================================================================*/
/*
#ifndef BOOST_ACT_CONSUMER_POLICY_IS_ONE_OF_FWD_HPP
#define BOOST_ACT_CONSUMER_POLICY_IS_ONE_OF_FWD_HPP
...
#include <boost/act/config/consumer_policy/max_is_one_of_params.hpp>
...
template< BOOST_PP_ENUM_BINARY_PARAMS( BOOST_ACT_MAX_IS_ONE_OF_PARAMS()
                                     , typename Type
...
struct is_is_one_of : mpl::false_ {};

template< BOOST_PP_ENUM_PARAMS( BOOST_ACT_MAX_IS_ONE_OF_PARAMS()
                              , typename Type
                              )
        >
struct is_is_one_of
       <
         is_one_of< BOOST_PP_ENUM_PARAMS( BOOST_ACT_MAX_IS_ONE_OF_PARAMS()
                                        , Type
                                        )
                  >
       >
...
template< typename IsOneOfType >
struct has_unary_is_one_of_sequence
  : mpl::equal_to< typename mpl::size
                     < typename IsOneOfType::type_sequence >::type
                 , mpl::size_t< 1 >
                 >
{
};
...
typedef parameter::parameters
        ...
        , parameter::optional< tag::constraint >
...
private:
  ...
  typedef typename mpl::eval_if
          <
            detail::is_is< constraint >
          , mpl::if_< detail::has_unary_is_sequence< constraint >
                    , use_convert_to
                    , use_convert_to_variant
                    >
          , mpl::if_< is_same< constraint, no_argument >
  ...
  typedef typename parameter::binding
          ...
          , typename mpl::eval_if
            ...
            , mpl::eval_if
              ...
              , detail::convert_to_meta< constraint >
              , mpl::eval_if
                <
                  is_same< default_normalizer_info, use_convert_to_variant >
                , detail::convert_to_variant_meta< constraint >
...
template< BOOST_PP_ENUM_PARAMS( BOOST_ACT_MAX_IS_ONE_OF_PARAMS(), typename Type ) >
struct is
{
  typedef mpl::vector
          <
            BOOST_PP_ENUM_PARAMS( BOOST_ACT_MAX_IS_ONE_OF_PARAMS(), Type )
          >
          type_sequence;
