/**
	@file
	Boost set_allocator.hpp header file.
...
template <typename T>
    ...
    public:
        ...
        template <typename U>
            struct rebind
            {
                typedef set_allocator<U> other;
            };

        set_allocator() throw()                                 {}
        set_allocator(const set_allocator &) throw()        {}
        template <typename U>
            set_allocator(const set_allocator<U> &) throw() {}
...
template <typename T>
    inline bool operator == (const set_allocator<T> &, const set_allocator<T> &)
    {
        return true;
    }
