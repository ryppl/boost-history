...
{
   typedef boost::intrusive::islist
      <ValueTraits
...
//test: assign, insert_after, const_iterator, erase_after, current, previous:
template<class ValueTraits>
void test_slist<ValueTraits>
...
//test: insert, const_iterator, erase, current:
template<class ValueTraits>
void test_slist<ValueTraits>
...
class test_main_template
{
   ...
   int operator()()
   {
      ...
      test_slist <typename testvalue_t::slist_member_hook::template
            value_traits<&testvalue_t::slist_node_> >::test_all(data);

/*
   test_slist <boost::intrusive::islist_ptr_to_member
      < testvalue_t        , typename testvalue_t::pointer
      , &testvalue_t::slist_prev_, &testvalue_t::slist_next_> >::test_all(data);
*/
      return 0;
   }
};
...
class test_main_template<VoidPointer, false>
{
   ...
   */
      ...
      test_slist <typename testvalue_t::slist_auto_member_hook::template
            value_traits<&testvalue_t::slist_auto_node_> >::test_all(data);
      return 0;
   }
};

//Explicit instantiations of non-counted classes
template class boost::intrusive::islist<slist_base_raw>;
template class boost::intrusive::islist<slist_member_raw>;
template class boost::intrusive::islist<slist_auto_base_raw>;
template class boost::intrusive::islist<slist_auto_member_raw>;
//template class boost::intrusive::islist<slist_ptr_to_member_raw>;
template class boost::intrusive::islist<slist_base_smart>;
template class boost::intrusive::islist<slist_member_smart>;
template class boost::intrusive::islist<slist_auto_base_smart>;
template class boost::intrusive::islist<slist_auto_member_smart>;
//template class boost::intrusive::islist<slist_ptr_to_member_smart>;

//Explicit instantiation of counted classes
template class boost::intrusive::islist<slist_base_raw_t, true>;
template class boost::intrusive::islist<slist_member_raw_t, true>;
//template class boost::intrusive::islist<slist_ptr_to_member_raw_t, true>;
template class boost::intrusive::islist<slist_base_smart_t, true>;
template class boost::intrusive::islist<slist_member_smart_t, true>;
//template class boost::intrusive::islist<slist_ptr_to_member_smart_t, true>;
