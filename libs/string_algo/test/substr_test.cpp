...
void find_test()
{
	...
	// basic tests
	nc_result=find( str1.begin(), str1.end(), str2.begin(), str2.end() );
	BOOST_CHECK( string( nc_result.first, nc_result.second)==str2 );
	cv_result=find( str1.begin(), str1.end(), str2.begin(), str2.end() );
...
void replace_test()
{
	...
	// basic tests
	BOOST_CHECK( replace_first( string("1abc3abc2"), string("abc"), string("YYY") )==string("1YYY3abc2") );
	BOOST_CHECK( replace_first( string("1abc3abc2"), string("abc"), string("Z") )==string("1Z3abc2") );
	BOOST_CHECK( replace_first( string("1abc3abc2"), string("abc"), string("XXXX") )==string("1XXXX3abc2") );

	BOOST_CHECK( replace_all( string("1abc3abc2"), string("abc"), string("YYY") )==string("1YYY3YYY2") );
	BOOST_CHECK( replace_all( string("1abc3abc2"), string("abc"), string("Z") )==string("1Z3Z2") );
	BOOST_CHECK( replace_all( string("1abc3abc2"), string("abc"), string("XXXX") )==string("1XXXX3XXXX2") );

	BOOST_CHECK( erase_first( string("1abc3abc2"), string("abc") )==string("13abc2") );
	BOOST_CHECK( erase_all( string("1abc3abc2"), string("abc") )==string("132") );

	// empty-string test
	BOOST_CHECK( replace_first( string("1abc3abc2"), string(""), string("YYY") )==string("1abc3abc2") );
	BOOST_CHECK( replace_first( string(""), string("abc"), string("Z") )==string("") );
	BOOST_CHECK( replace_all( string("1abc3abc2"), string(""), string("YYY") )==string("1abc3abc2") );
	BOOST_CHECK( replace_all( string(""), string("abc"), string("Z") )==string("") );
	...
	BOOST_CHECK( str1==string("123X456xxX321") );
	replace_all_in( str1, string("X"), string("mno") );
	BOOST_CHECK( str1==string("123mno456xxmno321") );
	replace_all_in( str1, string("mno"), string("ZZZ") );
	BOOST_CHECK( str1==string("123ZZZ456xxZZZ321") );
	erase_first_in( str1, string("ZZZ" ) );
	BOOST_CHECK( str1==string("123456xxZZZ321") );
	erase_all_in( str1, string("Z") );
	BOOST_CHECK( str1==string("123456xx321") );
}
