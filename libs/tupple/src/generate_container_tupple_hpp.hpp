...
PREPROCESS_LATER(#ifndef CONTAINER_TUPPLE_PART_SPEC_HPP)
PREPROCESS_LATER(#define CONTAINER_TUPPLE_PART_SPEC_HPP)
#else
PREPROCESS_LATER(#ifndef CONTAINER_TUPPLE_NO_PART_SPEC_HPP)
PREPROCESS_LATER(#define CONTAINER_TUPPLE_NO_PART_SPEC_HPP)
#endif
