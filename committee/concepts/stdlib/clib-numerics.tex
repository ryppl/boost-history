...
\begin{itemdecl}
@\ptr@template<class T> @\addedConcepts{requires HasSqrt<T> \&\& HasLog<T>}@ complex<T> acos(const complex<T>& @\farg{x}@);
\end{itemdecl}
...
\begin{itemdecl}
@\ptr@template<class T> @\addedConcepts{requires HasSqrt<T> \&\& HasLog<T>}@ complex<T> asin(const complex<T>& @\farg{x}@);
\end{itemdecl}
...
\begin{itemdecl}
@\ptr@template<class T> @\addedConcepts{requires HasAtan2<T> \&\& HasLog<T>}@ complex<T> atan(const complex<T>& @\farg{x}@);
\end{itemdecl}
...
\begin{itemdecl}
@\ptr@template<class T> @\addedConcepts{requires HasSqrt<T> \&\& HasLog<T>}@ complex<T> acosh(const complex<T>& @\farg{x}@);
\end{itemdecl}
...
\begin{itemdecl}
@\ptr@template<class T> @\addedConcepts{requires HasSqrt<T> \&\& HasLog<T>}@ complex<T> asinh(const complex<T>& @\farg{x}@);
\end{itemdecl}
...
\begin{itemdecl}
@\ptr@template<class T> @\addedConcepts{requires HasAtan2<T> \&\& HasLog<T>}@ complex<T> atanh(const complex<T>& @\farg{x}@);
\end{itemdecl}
