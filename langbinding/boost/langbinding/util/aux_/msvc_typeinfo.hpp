...
namespace boost { namespace langbinding { namespace util { namespace aux { 
...
{
    return aux::typeid_ref(
        (boost::type<T>*)0, aux::is_ref_tester1(type<T>())
        );
}
...
}}}} // namespace boost::langbinding::util::aux
