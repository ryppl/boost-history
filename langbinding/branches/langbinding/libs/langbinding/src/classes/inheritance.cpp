...
#include <boost/langbinding/classes/config.hpp>
...
namespace
{
  ...
  //
  typedef langbinding::util::type_info class_id;
...
BOOST_LANGBINDING_DECL void* find_static_type(void* p, class_id src_t, class_id dst_t)
{
...
BOOST_LANGBINDING_DECL void register_dynamic_id_aux(
