...
// Pair container traits ---------------------------------------------------------------------
            ...
            struct pair_container_traits
            {
                ...
                typedef BOOST_STRING_TYPENAME ::boost::detail::
                    iterator_traits<element_type>::difference_type size_type;
                typedef BOOST_STRING_TYPENAME ::boost::detail::
...
// Pointer container traits ---------------------------------------------------------------
            ...
            struct pointer_container_traits
            {
                ...
                typedef BOOST_STRING_TYPENAME char_traits::off_type difference_type;
                typedef BOOST_STRING_TYPENAME char_traits::pos_type size_type;
