...
//  replace_first_in ( in-place version ) ---------------------------------//
...
//  replace_all_in ( in-place version ) ---------------------------------//
...
*/
	...
	inline void erase_first(
		...
		BinaryPredicate Comp )
	{
		replace_first( Begin, End, MatchBegin, MatchBegin, End, End, Output, Comp );
	}
	...
	inline void erase_first(
		...
		OutputIterator Output )
	{
		replace_first( Begin, End, MatchBegin, MatchBegin, End, End, Output );
	}
	...
	InputSeq& erase_first_in( 
		...
		BinaryPredicate Comp )
	{
		return replace_first_in( Input, Match, InputSeq(), Comp );
	}
	...
	InputSeq& erase_first_in( 
		...
		const MatchSeq& Match )
	{
		return replace_first_in( Input, Match, InputSeq() );
	}
	...
	inline void erase_all(
		...
		BinaryPredicate Comp )
	{
		replace_all( Begin, End, MatchBegin, MatchEnd, End, End, Output, Comp );
	}
	...
	inline void erase_all(
		...
		OutputIterator Output )
	{
		replace_all( Begin, End, MatchBegin, MatchEnd, End, End, Output );
	}
	...
	InputSeq& erase_all_in( 
		...
		BinaryPredicate Comp )
	{
		return replace_all_in( Input, Match, InputSeq(), Comp );
	}
	...
	InputSeq& erase_all_in( 
		...
		const MatchSeq& Match )
	{
		return replace_all_in( Input, Match, InputSeq() );
	}
