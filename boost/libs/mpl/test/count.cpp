...
{    
    ...
    BOOST_STATIC_ASSERT((mpl::count< values, mpl::int_t<1> >::value == 2));
    BOOST_STATIC_ASSERT((mpl::count< values, mpl::int_t<0> >::value == 2));
    BOOST_STATIC_ASSERT((mpl::count< values, mpl::int_t<5> >::value == 3));
    BOOST_STATIC_ASSERT((mpl::count< values, mpl::int_t<7> >::value == 1));
    BOOST_STATIC_ASSERT((mpl::count< values, mpl::int_t<8> >::value == 0));
