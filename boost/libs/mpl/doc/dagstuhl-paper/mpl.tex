...
{
    typedef typename TinyList::template item<Pos>::type type;
    typedef tiny_list_iterator<TinyList, Pos-1> prior;
    typedef tiny_list_iterator<TinyList, Pos+1> next;
    temtiny_list_iterator<TinyList, Pos+1> next;
...
struct tiny_list
{
    ...
    template< long > struct item;
};

template< typename T1, typename T2, typename T3 >
template<> tiny_list::item<1> { typedef T1 type; };

template< typename T1, typename T2, typename T3 >
template<> tiny_list::item<2> { typedef T2 type; };

template< typename T1, typename T2, typename T3 >
template<> tiny_list::item<3> { typedef T3 type; };
\end{verbatim}
}
