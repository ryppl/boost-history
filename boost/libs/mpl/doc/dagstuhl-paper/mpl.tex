...
Suppose a user wished to find the largest of an arbitrary collection
of types. First, we'd need a way to represent the collection. One
...
The structure described by \code{types} above is similar to 
