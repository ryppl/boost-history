...
metaprogramming problem, even if no actual MPL code is used. The
library also provides a compile-time lambda facility that enables an
arbitrary currying and composition of class templates. This paper
explains motivation, usage, design, and implementation of /mpl/, with
advanced examples of its real-life applications, and offers some
lessons learned about C++ template metaprogramming.\end{abstract}
