...
with function objects in STL, with the nested \code{apply} template
...
\begin{itemize}
  ...
  is one of the distinguishing features of the modern 
...
had chosen to represent metafunctions as ordinary class templates.
...
metafunctions you are using operate on types, integral 
