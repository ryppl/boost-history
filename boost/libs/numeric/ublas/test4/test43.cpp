...
#ifdef USE_SLICE
            ublas::matrix_slice<ublas::banded_adaptor<M> > ms1 (bam1, ublas::range (0, 1, N), ublas::range (0, 1, N)), 
                                                                 ms2 (bam2, ublas::range (0, 1, N), ublas::range (0, 1, N)), 
                                                                 ms3 (bam3, ublas::range (0, 1, N), ublas::range (0, 1, N));
            (*this) (ms1, ms2, ms3);
#endif
        }
        catch (std::exception &e) {
