...
#ifdef USE_RANGE
            numerics::matrix_range<numerics::banded_adaptor<M> > mr1 (bam1, numerics::range (0, N), numerics::range (0, N)), 
																 mr2 (bam2, numerics::range (0, N), numerics::range (0, N)), 
																 mr3 (bam3, numerics::range (0, N), numerics::range (0, N));
            (*this) (mr1, mr2, mr3);
#endif

#ifdef USE_SLICE
            numerics::matrix_slice<numerics::banded_adaptor<M> > ms1 (bam1, numerics::range (0, 1, N), numerics::range (0, 1, N)), 
																 ms2 (bam2, numerics::range (0, 1, N), numerics::range (0, 1, N)), 
																 ms3 (bam3, numerics::range (0, 1, N), numerics::range (0, 1, N));
            (*this) (ms1, ms2, ms3);
#endif
		}
        catch (std::exception &e) {
