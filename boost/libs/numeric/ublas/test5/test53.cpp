...
#ifdef USE_SLICE
            ublas::matrix_slice<ublas::triangular_adaptor<M> > ms1 (tam1, ublas::range (0, 1, N), ublas::range (0, 1, N)), 
                                                               ms2 (tam2, ublas::range (0, 1, N), ublas::range (0, 1, N)), 
                                                               ms3 (tam3, ublas::range (0, 1, N), ublas::range (0, 1, N));
            (*this) (ms1, ms2, ms3);
#endif
        }
        catch (std::exception &e) {
