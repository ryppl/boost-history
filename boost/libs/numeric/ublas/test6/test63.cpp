...
#ifdef USE_SLICE
            ublas::matrix_slice<ublas::symmetric_adaptor<M> > ms1 (sam1, ublas::range (0, 1, N), ublas::range (0, 1, N)), 
                                                              ms2 (sam2, ublas::range (0, 1, N), ublas::range (0, 1, N)), 
                                                              ms3 (sam3, ublas::range (0, 1, N), ublas::range (0, 1, N));
            (*this) (ms1, ms2, ms3);
#endif
        }
        catch (std::exception &e) {
