...
#ifdef USE_RANGE_AND_SLICE
            ublas::matrix_vector_range<ublas::symmetric_adaptor<M> > mvr1 (tam1, 0, N, 0, N), mvr2 (tam1, 0, N, 0, N);
            (*this) (mvr1, mvr2, tam1);

            ublas::matrix_vector_slice<ublas::symmetric_adaptor<M> > mvs1 (tam1, 0, 1, N, 0, 1, N), mvs2 (tam1, 0, 1, N, 0, 1, N);
            (*this) (mvs1, mvs2, tam1);
#endif
        }
        catch (std::exception &e) {
