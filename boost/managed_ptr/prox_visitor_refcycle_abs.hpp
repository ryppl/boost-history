//prox_visitor(arg to prox_children) to handle just curry_prox_visitor_refcycle_counted<this_type>::owner_void
#ifndef BOOST_MANAGED_PTR_PROX_VISITOR_REFCYCLE_ABS_HPP_LJE20031122
#define BOOST_MANAGED_PTR_PROX_VISITOR_REFCYCLE_ABS_HPP_LJE20031122
...
//  ownership policy:
//    curry_prox_visitor_refcycle_counted<this_type>::owner_void
{
 public:
...
#include "boost/managed_ptr/BOOST_SMART_POINTER_PARAMS_POLICIES_suffix.hpp"
    ...
    template
      ...
      void 
    visit_prox
    ( curry_prox_visitor_refcycle_counted<this_type>::owner<Referent*>& a_typed_owner
    )
    {
...
;//end prox_visitor_refcycle_abs
    ...
    //  2) http://groups.google.com/groups?hl=en&lr=&ie=UTF-8&selm=10422s0n4gtdaac%40corp.supernews.com
    {
      ...
      struct nester_of
      < curry_prox_visitor_refcycle_counted<prox_visitor_refcycle_abs>::owner<Referent*>
      >
      {
          typedef curry_prox_visitor_refcycle_counted<prox_visitor_refcycle_abs> type;
      };
