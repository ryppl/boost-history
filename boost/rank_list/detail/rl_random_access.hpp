//  boost/rank_list/detail/rl_random_access.hpp
...
#ifndef _BOOST_RANK_LIST_RANDOM_ACCESS_HPP_
#define _BOOST_RANK_LIST_RANDOM_ACCESS_HPP_
...
inline
  ...
  rank_list<T,A,W,P>::operator[]
  (typename rank_list<T,A,W,P>::size_type n)    const
{
...
// index in the rlist. In the way, it also returns a
...
//not inline
  ...
  rank_list<T,A,W,P>::position_of_node
  (const typename rank_list<T,A,W,P>::node_t * p,
...
//not inline
  ...
  rank_list<T,A,W,P>::node_at_pos
  (typename rank_list<T,A,W,P>::size_type pos) const
{
  node_t * p;
