...
//! rbtree_algorithms provides basic algorithms to manipulate a sequence of
...
//! <b>Typedefs</b>:
//!
//! <tt>node</tt>: The type of the node that forms the tree
//!
...
struct rbtree_algorithms
{
   ...
   //! The type that stores the color
   ...
   //! <b>Requires</b>: this_node and other_node must be the header nodes
   //!  of two sequences.
   //! 
   //! <b>Effects</b>: Swaps two trees. After the function header1 will contain 
   //!   links to the second sequence and header2 will have links to the first sequence.
   //! 
   ...
   //! 
   //! <b>Returns</b>: 0 if the header is the only node of the tree.
   //!   A pointer to the leftmost node otherwise.
   //! 
   ...
   //! <b>Requires</b>: node is a node of the sequence or an node initialized
   //!   by init(...).
   //! 
