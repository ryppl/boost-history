...
#ifndef BOOST_METAMATH_DOUBLE_EQUAL_TO_HPP
#define BOOST_METAMATH_DOUBLE_EQUAL_TO_HPP
...
namespace boost { namespace mpl {
    ...
    >
   {
       template< typename N1, typename N2 > struct apply
           : metamath::detail::equal_to_double_double<N1,N2>::type
       {};
   };
   ...
   {
       template< typename N1, typename N2 > struct apply
           : metamath::detail::equal_to_double_double<N1,metamath::integral_to_double<N2> >::type
       {};
   };
   ...
   {
       template< typename N1, typename N2 > struct apply
           : metamath::detail::equal_to_double_double<metamath::integral_to_double<N1>,N2>::type
       {};
   };
}}
