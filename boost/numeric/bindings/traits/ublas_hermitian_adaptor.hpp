...
#ifndef BOOST_NUMERIC_BINDINGS_TRAITS_UBLAS_HERMITIAN_ADAPTOR_H
#define BOOST_NUMERIC_BINDINGS_TRAITS_UBLAS_HERMITIAN_ADAPTOR_H
...
namespace boost { namespace numeric { namespace bindings { namespace traits {
  ...
  struct hermitian_adaptor_traits<
    boost::numeric::ublas::hermitian_adaptor<M, F2>
  >
  {
  ...
  template <typename M, typename F2>
  struct hermitian_adaptor_traits<
    boost::numeric::ublas::hermitian_adaptor<M, F2> const
  >
  {
    typedef boost::numeric::ublas::hermitian_adaptor<M, F2> matrix_type;
    typedef typename M::value_type value_type; 
