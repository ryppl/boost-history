...
//#  define TRAITSTEMPLATE(k,a,b) template<BOOST_PP_ENUM_PARAMS(k,class a),BOOST_PP_ENUM(k,b,_)>
    template < class T > struct container_tuple0
    {
      ...
      template < class R0 > struct container_traits_tuple1
    {
      ...
      template < class T0 > struct container_tuple1:public tuple1 < T0 >
    {
      ...
      template < class S0 > container_tuple1( const container_tuple1 < S0 >
                                              &rhs ):tuple1 < T0 > ( rhs )
      {
      }
    ...
    template < class T0,
      class T1 > struct container_tuple2:public tuple2 < T0, T1 >
    {
      ...
      template < class S0,
        class S1 > container_tuple2( const container_tuple2 < S0,
    ...
    template < class T0, class T1,
      class T2 > struct container_tuple3:public tuple3 < T0, T1, T2 >
    {
      ...
      template < class S0, class S1,
        class S2 > container_tuple3( const container_tuple3 < S0, S1,
    ...
    template < class T0, class T1, class T2,
      class T3 > struct container_tuple4:public tuple4 < T0, T1, T2, T3 >
    {
      ...
      template < class S0, class S1, class S2,
        class S3 > container_tuple4( const container_tuple4 < S0, S1, S2,
    ...
    template < class T0, class T1, class T2, class T3,
      class T4 > struct container_tuple5:public tuple5 < T0, T1, T2, T3, T4 >
    {
      ...
      template < class S0, class S1, class S2, class S3,
        class S4 > container_tuple5( const container_tuple5 < S0, S1, S2, S3,
    ...
    template < class T0, class T1, class T2, class T3, class T4,
      class T5 > struct container_tuple6:public tuple6 < T0, T1, T2, T3, T4,
      T5 >
    {
      ...
      template < class S0, class S1, class S2, class S3, class S4,
        class S5 > container_tuple6( const container_tuple6 < S0, S1, S2, S3,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6 > struct container_tuple7:public tuple7 < T0, T1, T2, T3, T4,
      T5, T6 >
    {
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6 > container_tuple7( const container_tuple7 < S0, S1, S2, S3,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7 > struct container_tuple8:public tuple8 < T0, T1, T2,
      T3, T4, T5, T6, T7 >
    {
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6, class S7 > container_tuple8( const container_tuple8 < S0,
                                               S1, S2, S3, S4, S5, S6,
                                               S7 > &rhs ):tuple8 < T0, T1,
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7,
      class T8 > struct container_tuple9:public tuple9 < T0, T1, T2, T3, T4,
      T5, T6, T7, T8 >
    {
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6, class S7,
        class S8 > container_tuple9( const container_tuple9 < S0, S1, S2, S3,
    ...
    namespace detail
    {
      template < class T > struct n_fold_container_helper
      {
        template < int N > struct cont_select
        {
          ...
          template <> struct cont_select <0 >
        {
          typedef container_tuple0 < null_type > type;
        };
          template <> struct cont_select <1 >
        {
    ...
    {
      // The initial case.
      template < class T0 > struct container_tuple_base_type_selector1
      {
        ...
        template < class T0, class T1 > struct container_tuple_base_type_selector2
      {
        ...
        template < class T0, class T1, class T2 > struct container_tuple_base_type_selector3
      {
        ...
        template < class T0, class T1, class T2, class T3 > struct container_tuple_base_type_selector4
      {
        ...
        template < class T0, class T1, class T2, class T3, class T4 > struct container_tuple_base_type_selector5
      {
        ...
        template < class T0, class T1, class T2, class T3, class T4,
        class T5 > struct container_tuple_base_type_selector6
      {
        ...
        template < class T0, class T1, class T2, class T3, class T4, class T5,
        class T6 > struct container_tuple_base_type_selector7
      {
        ...
        template < class T0, class T1, class T2, class T3, class T4, class T5,
        class T6, class T7 > struct container_tuple_base_type_selector8
      {
        ...
        template < class T0, class T1, class T2, class T3, class T4, class T5,
        class T6, class T7,
        class T8 > struct container_tuple_base_type_selector9
      {
      ...
      T8 >::type
    {
      ...
      template < class V0 > container_tuple( V0 v0 ):self_type( v0 )
      {
      }
    template < class V0, class V1 > container_tuple( V0 v0, V1 v1 ):self_type( v0,
                 v1 )
      {
      }
    template < class V0, class V1, class V2 > container_tuple( V0 v0, V1 v1, V2 v2 ):self_type( v0, v1,
                 v2 )
      {
      }
    template < class V0, class V1, class V2, class V3 > container_tuple( V0 v0, V1 v1, V2 v2, V3 v3 ):self_type( v0, v1, v2,
                 v3 )
      {
      }
    template < class V0, class V1, class V2, class V3, class V4 > container_tuple( V0 v0, V1 v1, V2 v2, V3 v3, V4 v4 ):self_type( v0, v1, v2, v3,
                 v4 )
      {
      }
    template < class V0, class V1, class V2, class V3, class V4, class V5 > container_tuple( V0 v0, V1 v1, V2 v2, V3 v3, V4 v4, V5 v5 ):self_type( v0, v1, v2, v3, v4,
                 v5 )
      {
      }
    template < class V0, class V1, class V2, class V3, class V4, class V5, class V6 > container_tuple( V0 v0, V1 v1, V2 v2, V3 v3, V4 v4, V5 v5, V6 v6 ):self_type( v0, v1, v2, v3, v4, v5,
                 v6 )
      {
      }
    template < class V0, class V1, class V2, class V3, class V4, class V5, class V6, class V7 > container_tuple( V0 v0, V1 v1, V2 v2, V3 v3, V4 v4, V5 v5, V6 v6, V7 v7 ):self_type( v0, v1, v2, v3, v4, v5, v6,
                 v7 )
      {
      }
    template < class V0, class V1, class V2, class V3, class V4, class V5, class V6, class V7, class V8 > container_tuple( V0 v0, V1 v1, V2 v2, V3 v3, V4 v4, V5 v5, V6 v6, V7 v7, V8 v8 ):self_type( v0, v1, v2, v3, v4, v5, v6, v7,
                 v8 )
      {
      }
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6, class S7,
        class S8 > base_type & operator=( const container_tuple < S0, S1, S2,
