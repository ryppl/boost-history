...
//#  define TRAITSDEFAULT(z,k,_) class R##k = detail::iterator_traits<T##k>
    ...
    template < class T0 > iterator_tuple1 <
    ...
    template < class T0, class T1 > struct iterator_tuple2:public tuple2 < T0,
      T1 >
    {
    ...
    template < class T0, class T1, class T2, class T3, class T4,
      class T5 > struct iterator_tuple6:public tuple6 < T0, T1, T2, T3, T4,
      T5 >
    {
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6 > struct iterator_tuple7:public tuple7 < T0, T1, T2, T3, T4,
      T5, T6 >
    {
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7 > struct iterator_tuple8:public tuple8 < T0, T1, T2,
      T3, T4, T5, T6, T7 >
    {
    ...
    template < class T0, class T1, class T2, class T3, class T4, class T5,
      class T6, class T7,
      class T8 > struct iterator_tuple9:public tuple9 < T0, T1, T2, T3, T4,
      T5, T6, T7, T8 >
    {
    ...
    namespace detail
    {
      template < class T > struct n_fold_iterator_helper
      {
        template < int N > struct iter_select
        {
          ...
          template <> struct iter_select <0 >
        {
          typedef iterator_tuple0 < null_type > type;
        };
          template <> struct iter_select <1 >
        {
    ...
    {
      // The initial case.
      template < class T0 > struct iterator_tuple_base_type_selector1
      {
        typedef::boost::mpl::if_c <::boost::is_same < T0, null_type >::value,
          iterator_tuple0 < null_type >, iterator_tuple1 < T0 > >::type type;
      };

        template < class T0, class T1 > struct iterator_tuple_base_type_selector2
      {
        ...
        template < class T0, class T1, class T2 > struct iterator_tuple_base_type_selector3
      {
        ...
        template < class T0, class T1, class T2, class T3 > struct iterator_tuple_base_type_selector4
      {
        ...
        template < class T0, class T1, class T2, class T3, class T4 > struct iterator_tuple_base_type_selector5
      {
        ...
        template < class T0, class T1, class T2, class T3, class T4,
        class T5 > struct iterator_tuple_base_type_selector6
      {
        ...
        template < class T0, class T1, class T2, class T3, class T4, class T5,
        class T6 > struct iterator_tuple_base_type_selector7
      {
        ...
        template < class T0, class T1, class T2, class T3, class T4, class T5,
        class T6, class T7 > struct iterator_tuple_base_type_selector8
      {
        ...
        template < class T0, class T1, class T2, class T3, class T4, class T5,
        class T6, class T7,
        class T8 > struct iterator_tuple_base_type_selector9
      {
      ...
      T8 >::type
    {
      ...
      template < class V0 > iterator_tuple( V0 v0 ):self_type( v0 )
      {
      }
    template < class V0, class V1 > iterator_tuple( V0 v0, V1 v1 ):self_type( v0,
                 v1 )
      {
      }
    template < class V0, class V1, class V2 > iterator_tuple( V0 v0, V1 v1, V2 v2 ):self_type( v0, v1,
                 v2 )
      {
      }
    template < class V0, class V1, class V2, class V3 > iterator_tuple( V0 v0, V1 v1, V2 v2, V3 v3 ):self_type( v0, v1, v2,
                 v3 )
      {
      }
    template < class V0, class V1, class V2, class V3, class V4 > iterator_tuple( V0 v0, V1 v1, V2 v2, V3 v3, V4 v4 ):self_type( v0, v1, v2, v3,
                 v4 )
      {
      }
    template < class V0, class V1, class V2, class V3, class V4, class V5 > iterator_tuple( V0 v0, V1 v1, V2 v2, V3 v3, V4 v4, V5 v5 ):self_type( v0, v1, v2, v3, v4,
                 v5 )
      {
      }
    template < class V0, class V1, class V2, class V3, class V4, class V5, class V6 > iterator_tuple( V0 v0, V1 v1, V2 v2, V3 v3, V4 v4, V5 v5, V6 v6 ):self_type( v0, v1, v2, v3, v4, v5,
                 v6 )
      {
      }
    template < class V0, class V1, class V2, class V3, class V4, class V5, class V6, class V7 > iterator_tuple( V0 v0, V1 v1, V2 v2, V3 v3, V4 v4, V5 v5, V6 v6, V7 v7 ):self_type( v0, v1, v2, v3, v4, v5, v6,
                 v7 )
      {
      }
    template < class V0, class V1, class V2, class V3, class V4, class V5, class V6, class V7, class V8 > iterator_tuple( V0 v0, V1 v1, V2 v2, V3 v3, V4 v4, V5 v5, V6 v6, V7 v7, V8 v8 ):self_type( v0, v1, v2, v3, v4, v5, v6, v7,
                 v8 )
      {
      }
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6, class S7,
        class S8 > base_type & operator=( const iterator_tuple < S0, S1, S2,
