...
inline
bool
boost::math::big_radix_whole<Radix, Allocator>::test_invariant
(
) const
{
    using namespace boost::lambda;

    return this->digits_.empty() || 0 != this->digits_.back()
     && this->digits_.end() == std::find_if( this->digits_.begin(),
     this->digits_.end(), _1 < 0 || _1 >= self_type::radix );
}
