...
extern "C" __declspec(dllimport) void __stdcall 
   GetSystemTimeAsFileTime(struct _FILETIME*);
extern "C" __declspec(dllimport) void * __stdcall CreateMutexA
   (struct _SECURITY_ATTRIBUTES*, int, const char *);
extern "C" __declspec(dllimport) unsigned long __stdcall WaitForSingleObject
   (void *, unsigned long);
extern "C" __declspec(dllimport) int __stdcall ReleaseMutex
   (void *);
extern "C" __declspec(dllimport) int __stdcall UnmapViewOfFile
   (const void *);
extern "C" __declspec(dllimport) void * __stdcall CreateSemaphoreA
   (struct _SECURITY_ATTRIBUTES*, long, long, const char *);
extern "C" __declspec(dllimport) int __stdcall ReleaseSemaphore
   (void *, long, long *);
extern "C" __declspec(dllimport) void * __stdcall OpenSemaphoreA
   (unsigned long, int, const char *);
extern "C" __declspec(dllimport) void * __stdcall CreateFileMappingA
   (void *, struct _SECURITY_ATTRIBUTES*, unsigned long, unsigned long, unsigned long, const char *);
...
extern "C" __declspec(dllimport) void * __stdcall OpenFileMappingA
   (unsigned long, int, const char *);
extern "C" __declspec(dllimport) void * __stdcall CreateFileA
   (const char *, unsigned long, unsigned long, struct _SECURITY_ATTRIBUTES*, unsigned long, unsigned long, void *);
extern "C" __declspec(dllimport) void __stdcall GetSystemInfo
   (struct _SYSTEM_INFO *);
extern "C" __declspec(dllimport) int __stdcall FlushViewOfFile
...
{
   return MapViewOfFileEx(handle, file_access, highoffset, lowoffset, (unsigned long)numbytes, base_addr);
}
...
{
   return FlushViewOfFile(base_addr, (unsigned long)numbytes);
}
