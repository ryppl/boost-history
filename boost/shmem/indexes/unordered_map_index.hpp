...
#ifndef BOOST_SHMEM_UNORDERED_MAP_INDEX_HPP
#define BOOST_SHMEM_UNORDERED_MAP_INDEX_HPP

#include <functional>
#include <utility>
#include <boost/unordered_map.hpp>
#include <boost/shmem/private_node_allocator.hpp>
   ...
   typedef private_node_pool
      ...
      : std::unary_function<key_type, std::size_t>
    {
        std::size_t operator()(const key_type &val) const
        {
            ...
            const char_type *beg = val.m_str.get(),
                            *end = beg + val.m_len;
...
struct is_node_index
   <boost::shmem::unordered_map_index<MapConfig> >
{
   enum {   value = true };
};
...
#endif   //#ifndef BOOST_SHMEM_UNORDERED_MAP_INDEX_HPP
