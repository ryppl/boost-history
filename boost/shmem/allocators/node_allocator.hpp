...
#ifndef BOOST_SHMEM_POOLED_NODE_ALLOCATOR_HPP
#define BOOST_SHMEM_POOLED_NODE_ALLOCATOR_HPP
...
struct has_convertible_construct
   <boost::shmem::node_allocator<T, N, A> >
{
   enum {   value = true };
};
...
#endif   //#ifndef BOOST_SHMEM_POOLED_NODE_ALLOCATOR_HPP
