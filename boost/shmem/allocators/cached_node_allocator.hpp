...
#ifndef BOOST_SHMEM_CACHED_NODE_ALLOCATOR_HPP
#define BOOST_SHMEM_CACHED_NODE_ALLOCATOR_HPP
...
class cached_node_allocator
{
 ...
 private:
   ...
   /*!Initialization function, creates an executes atomically the 
      initialization object functions. Can throw boost::shmem::bad_alloc*/
...
struct has_convertible_construct
   <boost::shmem::cached_node_allocator<T, SegmentManager> >
{
   enum {   value = true };
};
...
#endif   //#ifndef BOOST_SHMEM_CACHED_NODE_ALLOCATOR_HPP
