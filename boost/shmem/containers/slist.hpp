...
#ifndef BOOST_SHMEM_SLIST_HPP
#define BOOST_SHMEM_SLIST_HPP
...
template <class T, class Alloc>
class insert_iterator<boost::shmem::slist<T, Alloc> > 
{
 protected:
   typedef boost::shmem::slist<T, Alloc> Container;
   Container* container;
