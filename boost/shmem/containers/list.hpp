...
#ifndef BOOST_SHMEM_LIST_HPP_
#define BOOST_SHMEM_LIST_HPP_
   ...
   : public shmem_list_node_base<A>
{
   ...
   shmem_list_node(const value_t &value)
      : m_data(value){}
      ...
      public A
{
   ...
   shmem_list_alloc(const ValAlloc &a) 
      : NodeAlloc(a), PtrAlloc(a), ValAlloc(a) 
      {  priv_init();   }

   shmem_list_alloc(const shmem_list_alloc &other)
...
struct shmem_list_alloc<T, A, true>
   :  public boost::detail::allocator::
         rebind_to<A, shmem_list_node<A> >::type
{
...
template <class T, class A>
class list 
   : protected detail::shmem_list_alloc<T, A, 
      has_convertible_construct<A>::value>
{
   typedef detail::shmem_list_alloc<T, A,
   ...
   typedef detail::shmem_list_node<A>                 Node;
