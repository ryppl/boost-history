#ifndef BOOST_INTERVAL_LIMITS_HPP
#define BOOST_INTERVAL_LIMITS_HPP
...
namespace std {
  ...
  class numeric_limits<boost::interval<T, Policies> >
    : public numeric_limits<T>
  {
  private:
    typedef boost::interval<T, Policies> I;
...
#endif // BOOST_INTERVAL_LIMITS_HPP
