...
new_(A const& a)
{
    ...
    return make_composite_t::type(
        make_composite_t::composite_type(new_1<T>(), a));
}
...
new_(A const& a, B const& b)
{
    ...
    return make_composite_t::type(
        make_composite_t::composite_type(new_2<T>(), a, b));
}
...
new_(A const& a, B const& b, C const& c)
{
    ...
    return make_composite_t::type(
        make_composite_t::composite_type(new_3<T>(), a, b, c));
}
    ...
    A const& a, B const& b, C const& c, D const& d)
{
    ...
    return make_composite_t::type(
        make_composite_t::composite_type(new_4<T>(), a, b, c, d));
}
    ...
    A const& a, B const& b, C const& c, D const& d, E const& e)
{
    ...
    return make_composite_t::type(
        make_composite_t::composite_type(new_5<T>(), a, b, c, d, e));
}
    ...
    F const& f)
{
    ...
    return make_composite_t::type(
        make_composite_t::composite_type(new_6<T>(), a, b, c, d, e, f));
}
