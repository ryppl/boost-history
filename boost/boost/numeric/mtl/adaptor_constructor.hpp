...
#ifndef MTL_ADAPTOR_CONSTRUCTOR_HPP
#define MTL_ADAPTOR_CONSTRUCTOR_HPP
...
namespace mtl {
  ...
  template <class Base>
  class adaptor_constructor : public Base
  {
    template <class X1>
    adaptor_constructor(const X1& x1)
      : Base(make_tuple_ref(x1)) { }

    template <class X1, class X2>
    adaptor_constructor(const X1& x1, const X2& x2)
      : Base(make_tuple_ref(x1, x2)) { }

    template <class X1, class X2, class X3>
    adaptor_constructor(const X1& x1, const X2& x2, const X3& x3)
      : Base(make_tuple_ref(x1, x2, x3)) { }

    template <class X1, class X2, class X3, class X4>
    adaptor_constructor(const X1& x1, const X2& x2, const X3& x3, const X4& x4)
...
#endif // MTL_ADAPTOR_CONSTRUCTOR_HPP
