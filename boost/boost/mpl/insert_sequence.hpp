//-----------------------------------------------------------------------------
// boost mpl/insert_sequence.hpp header file
...
#ifndef BOOST_MPL_INSERT_SEQUENCE_HPP
#define BOOST_MPL_INSERT_SEQUENCE_HPP
...
struct insert_sequence_algorithm_traits
{
    template<
          typename Sequence
        , typename Iterator
...
struct insert_sequence
    : insert_sequence_algorithm_traits<
          typename mpl::sequence_traits<Sequence>::sequence_category
          >::template algorithm<Sequence, Iterator, OtherSequence>
{
};
...
#endif // BOOST_MPL_INSERT_SEQUENCE_HPP
