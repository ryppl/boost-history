...
// Replace the Borland instrinsic function #defines with inlined versions
...
#if defined(__BORLANDC__) && defined(strcat)
...
#if defined(__BORLANDC__) && defined(strlen)
...
#if defined(__BORLANDC__) && defined(strncpy)
...
#if defined(__BORLANDC__) && defined(strncat)
...
#if defined(__BORLANDC__) && defined(strncmp)
