...
namespace boost
{
    ...
    void reject_null_static_test(void)
    {
        smart_ptr<object, reject_null_static<_> > p;
    }
}
...
{
    test::test_suite* test = BOOST_TEST_SUITE("smart_ptr reject_null_static test");

    test->add(BOOST_TEST_CASE(&reject_null_static_test));
