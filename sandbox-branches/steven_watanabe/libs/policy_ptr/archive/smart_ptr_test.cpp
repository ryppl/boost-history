...
#include "boost/policy_ptr/latest/smart_ptr.hpp"
...
{
public:
    child_mi(bool& dead, int age, int ssn) : object(dead), super2(ssn), age_(age) { }
    int age(void) const { return age_; }
private:
    int age_;
};
...
void multi_inherit_test(void)
{
    bool dead(false);
    {
        typedef smart_ptr<child_mi, scalar_storage<_>, ref_counted<_>, assert_check<_> > sp_type;
        typedef smart_ptr<super2, scalar_storage<_>, ref_counted<_>, assert_check<_> > sp2_type;
        sp2_type p;
