...
void test_ifirst(fixed_view<ifirst> first)
{
    first.one(0, 0.0F);
    first.one("");
    first.two();
...
void test_isecond(fixed_view<isecond> second)
{
    second.three(0, 0.0F);
    second.three("");
    second.four();
...
void test_iderived1(fixed_view<iderived1> derived1)
{
    derived1.one(0, 0.0F);
    derived1.one("");
    derived1.two();
...
void test_ithird(fixed_view<ithird> third)
{
    third.five(0, 0.0F);
    third.five("");
    third.six();
...
void test_ifourth(fixed_view<ifourth> fourth)
{
    fourth.seven(0, 0.0F);
    fourth.seven("");
    fourth.eight();
...
void test_iderived3(fixed_view<iderived3> derived3)
{
...
void fixed_derived_to_base_test()
{
...
{
    test_suite* test = BOOST_TEST_SUITE("fixed derived to base test");
    test->add(BOOST_TEST_CASE(&fixed_derived_to_base_test));
    return test;
}
