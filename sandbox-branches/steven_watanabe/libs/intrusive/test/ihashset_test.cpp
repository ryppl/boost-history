...
template<class ValueTraits>
void test_hashset<ValueTraits>::test_all(std::vector<typename ValueTraits::value_type>& values)
{
   test_sort(values);
   test_insert(values);
   test_swap(values);
...
template<class ValueTraits>
void test_hashset<ValueTraits>::test_impl()
{
   ...
   typedef boost::intrusive::ihashset
      ...
      > hashset_type;
   typename hashset_type::bucket_type buckets [BucketSize];
   hashset_type testset(buckets, BucketSize);
   for (int i = 0; i < 5; ++i)
...
template<class ValueTraits>
void test_hashset<ValueTraits>::test_sort(std::vector<typename ValueTraits::value_type>& values)
{
   ...
   typedef boost::intrusive::ihashset
      ...
      > hashset_type;
   typename hashset_type::bucket_type buckets [BucketSize];
   hashset_type testset1(buckets, BucketSize, values.begin(), values.end());
...
template<class ValueTraits>
void test_hashset<ValueTraits>::test_insert(std::vector<typename ValueTraits::value_type>& values)
{
   typedef typename ValueTraits::value_type testvalue_t;
   boost::test_tools::output_test_stream test_seq;
   typedef boost::intrusive::ihashset
   ...
   const hashset_type& const_testset = testset;
   std::copy (const_testset.begin(), const_testset.end(), 
               std::ostream_iterator<testvalue_t> (test_seq));
   BOOST_CHECK (test_seq.is_equal ("145"));

   BOOST_DEDUCED_TYPENAME hashset_type::iterator i = testset.begin();
   ...
   testset.erase (i);
   //test post-increment:
   for (BOOST_DEDUCED_TYPENAME hashset_type::const_iterator i = const_testset.begin(),
...
template<class ValueTraits>
void test_hashset<ValueTraits>::test_swap(std::vector<typename ValueTraits::value_type>& values)
{
   typedef typename ValueTraits::value_type testvalue_t;
   boost::test_tools::output_test_stream test_seq;
   ...
   typename hashset_type::bucket_type buckets1 [BucketSize];
   hashset_type testset1(buckets1, BucketSize, &values[0], &values[0] + 2);

   typename hashset_type::bucket_type buckets2 [BucketSize];
   hashset_type testset2(buckets2, BucketSize);
   ...
   //test post-increment:
   for (BOOST_DEDUCED_TYPENAME hashset_type::iterator i = testset2.begin(),
...
template<class ValueTraits>
void test_hashset<ValueTraits>::test_rehash(std::vector<typename ValueTraits::value_type>& values)
{
   typedef typename ValueTraits::value_type testvalue_t;
   boost::test_tools::output_test_stream test_seq;
   ...
   typename hashset_type::bucket_type buckets1 [BucketSize];
   hashset_type testset1(buckets1, BucketSize, &values[0], &values[0] + 6);
   BOOST_CHECK (testset1.size() == 5);
   std::copy (testset1.begin(), testset1.end(), 
               std::ostream_iterator<testvalue_t> (test_seq));
   BOOST_CHECK (test_seq.is_equal ("12345"));

   typename hashset_type::bucket_type buckets2 [2];
   ...
   typename hashset_type::bucket_type buckets3 [BucketSize*2];
...
template<class ValueTraits>
void test_hashset<ValueTraits>::test_find(std::vector<typename ValueTraits::value_type>& values)
{
   typedef typename ValueTraits::value_type testvalue_t;
   boost::test_tools::output_test_stream test_seq;
   ...
   typedef boost::intrusive::ihashset
      ...
      > hashset_type;
   typename hashset_type::bucket_type buckets [BucketSize];
   hashset_type testset (buckets, BucketSize, values.begin(), values.end());
   typedef BOOST_DEDUCED_TYPENAME hashset_type::iterator iterator;
...
class test_main_template
{
   ...
   int operator()()
   {
      ...
      test_hashset <typename testvalue_t::hashset_base_hook::template
         value_traits<testvalue_t> >::test_all(data);

      test_hashset <typename testvalue_t::hashset_member_hook::template
            value_traits<&testvalue_t::hashset_node_> >::test_all(data);

//   test_hashset <boost::intrusive::ihashset_ptr_to_member
...
//         , &testvalue_t::hashset_prev_, &testvalue_t::hashset_next_> >::test_all(data);
      ...
      test_hashset <typename testvalue_t::hashset_auto_base_hook::template
         value_traits<testvalue_t> >::test_all(data);

      test_hashset <typename testvalue_t::hashset_auto_member_hook::template
...
template class boost::intrusive::ihashset<hashset_base_raw>;
template class boost::intrusive::ihashset<hashset_member_raw>;
template class boost::intrusive::ihashset<hashset_auto_base_raw>;
template class boost::intrusive::ihashset<hashset_auto_member_raw>;
//template class boost::intrusive::ihashset<hashset_ptr_to_member_raw>;
template class boost::intrusive::ihashset<hashset_base_smart>;
template class boost::intrusive::ihashset<hashset_member_smart>;
template class boost::intrusive::ihashset<hashset_auto_base_smart>;
template class boost::intrusive::ihashset<hashset_auto_member_smart>;
//template class boost::intrusive::ihashset<hashset_ptr_to_member_smart>;

//Explicit instantiation of counted classes
template class boost::intrusive::ihashset
   <hashset_base_raw_t
