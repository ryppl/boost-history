...
namespace boost 
{
    namespace collection_traits_detail
    {
        template< typename collectionT >     
            struct default_collection_traits
            {
                typedef BOOST_STRING_TYPENAME collectionT::value_type value_type;
                typedef BOOST_STRING_TYPENAME collectionT::iterator iterator;
                typedef BOOST_STRING_TYPENAME collectionT::const_iterator const_iterator;
                typedef BOOST_STRING_TYPENAME 
                    ::boost::mpl::if_< ::boost::is_const<collectionT>,
                        const_iterator,
                        iterator 
                    >::type result_iterator;
                typedef BOOST_STRING_TYPENAME collectionT::difference_type difference_type;
                typedef BOOST_STRING_TYPENAME collectionT::size_type size_type;
            ...
            template<typename T>
            struct default_collection_traits_selector
            {
                typedef default_collection_traits<T> type;
            };

// Pair collection traits ---------------------------------------------------------------------
            ...
            }; // 'pair_collection_helper'

            template<typename T>
            struct pair_collection_traits_selector
            {
                typedef pair_collection_traits<T> type;
            };

// Array collection traits ---------------------------------------------------------------
            ...
            */
            ...
            template< typename T >
            struct array_collection_traits
            {
            private:
            ...
            template<typename T>
            struct array_collection_traits_selector
            {
                typedef array_collection_traits<T> type;
            };

// Pointer collection traits ---------------------------------------------------------------

            template<typename T>
            struct pointer_collection_traits
            {
                typedef BOOST_STRING_TYPENAME
            ...
            template<typename T>
            struct pointer_collection_traits_selector
            {
                typedef pointer_collection_traits<T> type;
            };
