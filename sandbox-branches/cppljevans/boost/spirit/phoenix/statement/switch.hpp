...
#include <boost/spirit/phoenix/statement/impl/switch_eval.hpp>
#include <boost/spirit/phoenix/statement/impl/switch.ipp>
...
namespace boost { namespace phoenix
{
    ...
    struct switch_case_base
    {
        ...
        struct apply
        {
            typedef typename Actor::template apply<Args, Env>::type type;
        };
    ...
    struct switch_gen
    {
        ...
        typename lazy_enable_if<
          ...
          , impl::switch_composite_actor<Cond, Cases>
        >::type
        operator[](Cases const& cases) const
        {
            typedef typename
                impl::switch_composite<Cond, Cases>
            switch_composite;
        ...
        {
            typedef typename
                impl::switch_composite<Cond, fusion::tuple<actor<D> > >
            switch_composite;
    ...
    inline typename impl::compose_case_a<D0, D1>::type
    operator,(
        switch_case_base<D0, A0> const& _0
      , switch_case_base<D1, A1> const& _1
    )
    {
        return impl::compose_case_a<D0, D1>::apply(
    ...
    inline typename
        lazy_enable_if<
          ...
          , impl::compose_case_b<Seq, D>
        >::type
    operator,(Seq const& seq, switch_case_base<D, A> const& case_)
    {
        return impl::compose_case_b<Seq, D>::apply(
