...
namespace boost
{
  namespace tupple
  {
      ...
      null_type, class R9 = null_type > struct container_traits_tuple
    {
      ...
      template <> struct container_tuple <null_type, null_type, null_type,
      ...
      null_type >:public tuple < T0 >
    {
      ...
      template < class S0 > container_tuple( const container_tuple < S0 >
                                             &rhs ):tuple < T0 > ( rhs )
      {
      }
      ...
      null_type >:public tuple < T0, T1 >
    {
      ...
      template < class S0,
        class S1 > container_tuple( const container_tuple < S0,
      ...
      null_type >:public tuple < T0, T1, T2 >
    {
      ...
      template < class S0, class S1,
        class S2 > container_tuple( const container_tuple < S0, S1,
      ...
      T3 >
    {
      ...
      template < class S0, class S1, class S2,
        class S3 > container_tuple( const container_tuple < S0, S1, S2,
      ...
      T3, T4 >
    {
      ...
      template < class S0, class S1, class S2, class S3,
        class S4 > container_tuple( const container_tuple < S0, S1, S2, S3,
      ...
      T5 >
    {
      ...
      template < class S0, class S1, class S2, class S3, class S4,
        class S5 > container_tuple( const container_tuple < S0, S1, S2, S3,
      ...
      T6 >
    {
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6 > container_tuple( const container_tuple < S0, S1, S2, S3,
      ...
      T7 >
    {
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6, class S7 > container_tuple( const container_tuple < S0, S1,
                                              S2, S3, S4, S5, S6,
      ...
      T6, T7, T8 >
    {
      ...
      template < class S0, class S1, class S2, class S3, class S4, class S5,
        class S6, class S7,
        class S8 > container_tuple( const container_tuple < S0, S1, S2, S3,
    ...
    template < class T > struct n_fold_container_tuple <T, 0 >
    {
    ...
    template < class T > struct n_fold_container_tuple <T, 1 >
    {
    ...
    template < class T > struct n_fold_container_tuple <T, 2 >
    {
    ...
    template < class T > struct n_fold_container_tuple <T, 3 >
    {
    ...
    template < class T > struct n_fold_container_tuple <T, 4 >
    {
    ...
    template < class T > struct n_fold_container_tuple <T, 5 >
    {
    ...
    template < class T > struct n_fold_container_tuple <T, 6 >
    {
    ...
    template < class T > struct n_fold_container_tuple <T, 7 >
    {
    ...
    template < class T > struct n_fold_container_tuple <T, 8 >
    {
    ...
    template < class T > struct n_fold_container_tuple <T, 9 >
    {
