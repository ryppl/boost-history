...
//  dummy(get<5>(ct)); // illegal index
    ...
    using boost::fusion::tuple_detail::get_result;
    using boost::fusion::tuple_detail::const_get_result;

    BOOST_STATIC_ASSERT((
        boost::is_same<get_result<0, tuple<int, float> >::type, int&>::value));

    BOOST_STATIC_ASSERT((
        boost::is_same<const_get_result<0, tuple<int, float> >::type
      , const int&>::value));

    BOOST_STATIC_ASSERT((
        boost::is_same<get_result<1, tuple<int, float> >::type
      , float&>::value));

    BOOST_STATIC_ASSERT((
        boost::is_same<const_get_result<1, tuple<int, float> >::type
      , const float&>::value));

    BOOST_STATIC_ASSERT((
        boost::is_same<get_result<1, tuple<int, const float> >::type
        , const float&>::value));

    BOOST_STATIC_ASSERT((
        boost::is_same<get_result<0, tuple<int&, const float&> >::type
      , int&>::value));
    ...
    BOOST_STATIC_ASSERT((
        boost::is_same<const_get_result<0, tuple<int&, const float&> >::type
        , int&>::value));

    BOOST_STATIC_ASSERT((
        boost::is_same<const_get_result<1, tuple<int&, const float&> >::type
        , const float&>::value));
