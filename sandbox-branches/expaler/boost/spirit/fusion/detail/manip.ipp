...
==============================================================================*/
#ifndef BOOST_FUSION_TUPLE_MANIP_IPP
#define BOOST_FUSION_TUPLE_MANIP_IPP
...
#define STD_TUPLE_DEFINE_MANIPULATOR(name)                                      \
    ...
    {                                                                           \
        ...
        Stream& operator>>(Stream& s, const name##_type<CharT,Traits>& m)       \
    	{                                                                       \
...
#endif // BOOST_FUSION_TUPLE_MANIP_IPP
