...
void deref_test()
{
    ...
    unique_ptr<ifirst> pfirst(new cfirst<1>);
    pfirst->one(0, 0.0F);
    pfirst->one("");
    pfirst->two();
    (*pfirst).one(0, 0.0F);
    ...
    unique_ptr<iderived1> pderived1(new cderived1<1>);
    ...
    unique_ptr<iderived4> pderived4(new cderived4<1>);
...
{
    test_suite* test = BOOST_TEST_SUITE("unique_ptr deref test");
