//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Shmem of boost/shared_ptr.hpp
//
...
#ifndef BOOST_SHMEM_SHARED_PTR_HPP_INCLUDED
#define BOOST_SHMEM_SHARED_PTR_HPP_INCLUDED
...
#include <boost/shmem/smart_ptr/detail/shared_count.hpp>
...
class shared_ptr
{
   ...
   template<class Y> bool _internal_less(shared_ptr<Y, VA, D> const & rhs) const
...
bool operator==(shared_ptr<T, VA, D> const & a, shared_ptr<U, VA, D> const & b)
{  return a.get() == b.get(); }
...
#endif  // #ifndef BOOST_SHMEM_SHARED_PTR_HPP_INCLUDED
