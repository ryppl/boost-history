...
#ifndef BOOST_SHMEM_TREE_HPP
#define BOOST_SHMEM_TREE_HPP

#include <boost/shmem/detail/workaround.hpp>
#include <boost/shmem/detail/config_begin.hpp>
#include <boost/shmem/detail/utilities.hpp>
#include <boost/shmem/containers/detail/tree_func.hpp>
   ...
   : rb_tree_node_base<typename pointer_to_other<typename Alloc::pointer, void>::type>
{
   ...
   {
      return boost::shmem::do_static_cast<node_pointer>(upclass_pointer);
   }
