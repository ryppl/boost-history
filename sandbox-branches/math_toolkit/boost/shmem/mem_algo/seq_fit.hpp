...
#ifndef BOOST_SHMEM_SEQ_FIT_HPP
#define BOOST_SHMEM_SEQ_FIT_HPP
...
class seq_fit 
   : public basic_seq_fit<MutexFamily, VoidPointer>
{
   typedef basic_seq_fit<MutexFamily, VoidPointer> base_t;
 public:
   ...
   seq_fit           (size_t size, size_t extra_hdr_bytes)
...
#endif   //#ifndef BOOST_SHMEM_SEQ_FIT_HPP
