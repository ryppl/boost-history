...
#ifndef BOOST_SHMEM_NAMED_PROXY_HPP
#define BOOST_SHMEM_NAMED_PROXY_HPP
...
#  define BOOST_SHMEM_MAX_CONSTRUCTOR_PARAMETERS 10
#endif
...
#define BOOST_SHMEM_AUX_PARAM_LIST(z, n, data) \
  const BOOST_PP_CAT(P, n) & BOOST_PP_CAT(p, n) \
/**/

#define BOOST_SHMEM_AUX_PARAM_INIT(z, n, data) \
  BOOST_PP_CAT(m_p, n) (const_cast<BOOST_PP_CAT(P, n) &>(BOOST_PP_CAT(p, n))) \
/**/

#define BOOST_SHMEM_AUX_PARAM_INC(z, n, data)   \
  BOOST_PP_CAT(++m_p, n)                        \
/**/

#define BOOST_SHMEM_AUX_PARAM_DEFINE(z, n, data)   \
...
#define BOOST_PP_LOCAL_MACRO(n)                                         \
   ...
   {                                                                    \
      ...
      typedef T target_t;                                               \
                                                                        \
      void do_increment(boost::mpl::false_)                             \
         { BOOST_PP_ENUM(n, BOOST_SHMEM_AUX_PARAM_INC, _); }            \
                                                                        \
      void do_increment(boost::mpl::true_){}                            \
                                                                        \
      self_t& operator++()                                              \
      ...
      BOOST_PP_CAT(BOOST_PP_CAT(Ctor, n), Arg)                          \
         ( BOOST_PP_ENUM(n, BOOST_SHMEM_AUX_PARAM_LIST, _) )            \
         : BOOST_PP_ENUM(n, BOOST_SHMEM_AUX_PARAM_INIT, _) {}           \
                                                                        \
      void operator()(T* mem) const                                     \
         {  new (mem) T(BOOST_PP_ENUM_PARAMS(n, m_p));  }               \
                                                                        \
    private:                                                            \
         BOOST_PP_REPEAT(n, BOOST_SHMEM_AUX_PARAM_DEFINE, _)            \
   };                                                                   \
/**/

#define BOOST_PP_LOCAL_LIMITS (1, BOOST_SHMEM_MAX_CONSTRUCTOR_PARAMETERS)
#include BOOST_PP_LOCAL_ITERATE()

#undef BOOST_SHMEM_AUX_PARAM_LIST
#undef BOOST_SHMEM_AUX_PARAM_INIT
#undef BOOST_SHMEM_AUX_PARAM_DEFINE
#undef BOOST_SHMEM_AUX_PARAM_INC
...
class named_proxy
{
 ...
 public:
   ...
   #define BOOST_SHMEM_AUX_TYPE_LIST(z, n, data) \
      BOOST_PP_CAT(P, n) \
   /**/
   ...
   #define BOOST_PP_LOCAL_MACRO(n)                                            \
      ...
      T *operator()(BOOST_PP_ENUM (n, BOOST_SHMEM_AUX_PARAM_LIST, _)) const   \
      {                                                                       \
         typedef BOOST_PP_CAT(BOOST_PP_CAT(Ctor, n), Arg)                     \
            <T, param_or_it, BOOST_PP_ENUM (n, BOOST_SHMEM_AUX_TYPE_LIST, _)> \
            ctor_obj_t;                                                       \
   ...
   #include BOOST_PP_LOCAL_ITERATE()
   #undef BOOST_SHMEM_AUX_PARAM_LIST
   #undef BOOST_SHMEM_AUX_TYPE_LIST
...
#endif //#ifndef BOOST_SHMEM_NAMED_PROXY_HPP
