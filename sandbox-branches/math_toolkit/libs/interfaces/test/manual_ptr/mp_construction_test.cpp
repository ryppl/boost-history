...
void construction_test()
{
    ...
    {
        manual_ptr<ifirst> ptr1(new cfirst<2>);
    ...
    {
        manual_ptr<ifirst> ptr(new cderived1<1>);
        ptr->one(0, 0.0F);
        ptr->one("");
        ptr->two();
    ...
    {
        manual_ptr<iderived1> ptr1(new cderived1<2>);
        manual_ptr<ifirst> ptr2(ptr1);
        ptr2->one(0, 0.0F);
        ptr2->one("");
        ptr2->two();
    ...
    {
        manual_ptr<ifirst> ptr(new cderived4<1>);
        ptr->one(0, 0.0F);
        ptr->one("");
        ptr->two();
    ...
    {
        manual_ptr<iderived4> ptr1(new cderived4<2>);
        manual_ptr<ifirst> ptr2(ptr1);
        ptr2->one(0, 0.0F);
        ptr2->one("");
        ptr2->two();
...
{
    test_suite* test = BOOST_TEST_SUITE("manual_ptr construction test");
